...
//        UserController.userList.add(user);
    ...
    @Test
    void shouldAddUserIfUserNotExistWhenAddRsEvent() throws Exception {
        ...
        assertEquals("xiaoming",all.get(0).getUserName());
        assertEquals("a@b.com",all.get(0).getEmail());
        assertEquals("male",all.get(0).getAge());
        assertEquals("10",all.get(0).getVoteNum());
        assertEquals("19876545676",all.get(0).getPhone());
